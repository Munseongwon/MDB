...
import 'package:moviedb/movie/components/moive_discover_component.dart';
import 'package:moviedb/movie/components/moive_now_playing_component.dart';
import 'package:moviedb/movie/components/movie_top_rated_component.dart';
import 'package:moviedb/movie/pages/movie_pagination_page.dart';
import 'package:moviedb/movie/pages/movie_search_page.dart';
          ...
          _WidgetTitle(
            ...
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (_) =>
                      const MoviePaginationPage(type: TypeMovie.discover),
                ),
              );
            },
          ),
