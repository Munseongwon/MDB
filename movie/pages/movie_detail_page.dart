// ignore_for_file: prefer_const_constructors, unused_local_variable, prefer_const_literals_to_create_immutables, unused_element
...
import 'package:moviedb/widget/webview_widget.dart';
import 'package:moviedb/widget/youtube_player_widget.dart';
                    ...
                    child: _Content(
                      ...
                      body: SizedBox(
                        ...
                        child: ListView.separated(
                          ...
                          itemBuilder: (_, index) {
                            final video2 = videos.results[index];
                            return Stack(
                              children: [
                                ImageNetworkWidget(
                                  radius: 12,
                                    ...
                                    child: InkWell(
                                      onTap: () {
                                        Navigator.push(
                                          context,
                                          MaterialPageRoute(
                                            builder: (_) => YoutubePlayerWiget(
                                                youtubeKey: video2.key),
                                          ),
                                        );
                                      },
                                    ),
